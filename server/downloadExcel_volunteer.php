...
$templateExcel = ROOT."cache/templateExcel1.xlsx";
...
for ($i = 0; $i < $datas_count; $i++) {
  ...
  $objActSheet->getStyle("K$key")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
  ...
  $objActSheet->setCellValue("K$key", $datas[$i]['d3']);
}
ob_flush();
